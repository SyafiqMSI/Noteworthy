...
import com.example.noteworthy.databinding.ActivityNoteworthyBinding
...
import com.example.noteworthy.recyclerview.adapter.ErrorAdapter
import com.example.noteworthy.recyclerview.adapter.PreviewImageAdapter
import com.example.noteworthy.room.Folder
import com.example.noteworthy.room.Image
import com.example.noteworthy.room.Type
import com.example.noteworthy.viewmodels.NoteworthyModel
import com.example.noteworthy.widget.WidgetProvider
import kotlinx.coroutines.launch
import java.text.DateFormat

abstract class NoteworthyActivity(private val type: Type) : AppCompatActivity() {

    internal lateinit var binding: ActivityNoteworthyBinding
    internal val model: NoteworthyModel by viewModels()
            ...
            if (checkSelfPermission(permission) != PackageManager.PERMISSION_GRANTED) {
                if (shouldShowRequestPermissionRationale(permission)) {
                    MaterialAlertDialogBuilder(this)
                        .setMessage(R.string.please_grant_noteworthy)
    ...
    private fun initialiseBinding() {
        binding = ActivityNoteworthyBinding.inflate(layoutInflater)
        when (type) {
            Type.NOTE -> {
