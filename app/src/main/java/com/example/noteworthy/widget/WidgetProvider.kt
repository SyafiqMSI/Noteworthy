...
import com.example.noteworthy.activities.ConfigureWidget
...
class WidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            ACTION_CHECKED_CHANGED -> {
                ...
                val database = NoteworthyDatabase.getDatabase(context.applicationContext as Application)
    ...
    companion object {
        ...
        private const val EXTRA_MODIFIED_NOTES = "com.example.noteworthy.EXTRA_MODIFIED_NOTES"
        private const val ACTION_NOTES_MODIFIED = "com.example.noteworthy.ACTION_NOTE_MODIFIED"

        const val ACTION_OPEN_NOTE = "com.example.noteworthy.ACTION_OPEN_NOTE"
        const val ACTION_OPEN_LIST = "com.example.noteworthy.ACTION_OPEN_LIST"

        const val ACTION_CHECKED_CHANGED = "com.example.noteworthy.ACTION_CHECKED_CHANGED"
        const val EXTRA_POSITION = "com.example.noteworthy.EXTRA_POSITION"
    }
}