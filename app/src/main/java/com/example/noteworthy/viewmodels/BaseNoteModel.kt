...
import com.example.noteworthy.ActionMode
import com.example.noteworthy.BackupProgress
import com.example.noteworthy.Cache
import com.example.noteworthy.ImageDeleteService
import com.example.noteworthy.R
import com.example.noteworthy.legacy.Migrations
import com.example.noteworthy.legacy.XMLUtils
...
import com.example.noteworthy.miscellaneous.applySpans
import com.example.noteworthy.preferences.AutoBackup
import com.example.noteworthy.preferences.ListInfo
import com.example.noteworthy.preferences.Preferences
import com.example.noteworthy.preferences.SeekbarInfo
...
import com.example.noteworthy.room.livedata.Content
import com.example.noteworthy.room.livedata.SearchResult
    ...
    private fun importZipBackup(uri: Uri) {
        ...
        viewModelScope.launch(exceptionHandler) {
            ...
            withContext(Dispatchers.IO) {
                ...
                val databaseEntry = zipFile.getEntry(NoteworthyDatabase.DatabaseName)

                val databaseFile = File(backupDir, NoteworthyDatabase.DatabaseName)
