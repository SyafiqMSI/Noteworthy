...
import com.example.noteworthy.image.ImageProgress
...
import com.example.noteworthy.room.SpanRepresentation
...
class NoteworthyModel(private val app: Application) : AndroidViewModel(app) {
